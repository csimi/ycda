...
export default function StorySelect({ onPlay, isDark, onToggleTheme, llmStatus, llmProgress, llmLoadingPhase, llmModelId, llmError, onSwitchModel, onCancelLoad, onRetryLoad, uploadedStories, onUploadStory, saves, onLoadSave, onDeleteSave, onOpenSavesDialog, isMobile, fontSerif, onToggleFontSerif, fontScale, onIncreaseFontSize, onDecreaseFontSize }) {
  return (
    ...
    >
      <AppHeader isDark={isDark} onToggleTheme={onToggleTheme} llmStatus={llmStatus} llmProgress={llmProgress} llmLoadingPhase={llmLoadingPhase} llmModelId={llmModelId} llmError={llmError} onSwitchModel={onSwitchModel} onCancelLoad={onCancelLoad} onRetryLoad={onRetryLoad} onOpenSaves={onOpenSavesDialog} isMobile={isMobile} fontSerif={fontSerif} onToggleFontSerif={onToggleFontSerif} fontScale={fontScale} onIncreaseFontSize={onIncreaseFontSize} onDecreaseFontSize={onDecreaseFontSize} />
